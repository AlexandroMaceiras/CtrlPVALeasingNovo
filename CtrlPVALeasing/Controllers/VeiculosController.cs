...
namespace CtrlPVALeasing.Controllers
{
    public class VeiculosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id,contrato,tipo_registro,marca,modelo,tipo,ano_fab,ano_mod,cor,renavam,chassi,placa,origem")] Arm_Veiculos arm_Veiculos)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,contrato,tipo_registro,marca,modelo,tipo,ano_fab,ano_mod,cor,renavam,chassi,placa,origem")] Arm_Veiculos arm_Veiculos)
        {
            if (ModelState.IsValid)
            {
